...
function Home() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (value) => {
      if (isEdit) {
        await axios.put(`${import.meta.env.VITE_API}/product/${currentId}`, value, {
          headers: {
        ...
        await axios.post(`${import.meta.env.VITE_API}/product`, value, {
          headers: {
            Authorization: window.localStorage.getItem("app_token"),
          },
        });
  ...
  let handleFetch = async () => {
    try {
      const products = await axios.get(`${import.meta.env.VITE_API}/products`, {
        headers: {
          Authorization: window.localStorage.getItem("app_token"),
        },
      });
  ...
  let handleDelete = async (_id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API}/product/${_id}`, {
        headers: {
          Authorization: window.localStorage.getItem("app_token"),
        },
      });
